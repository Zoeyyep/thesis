...
class Preprocessor:
    ...
    def text_processing(df):
        n = len(df['Article'])
        df['Article'] = df['Article'].apply(lambda x: Preprocessor.cleanhtml(str(x)))
        df['Article'] = df['Article'].apply(lambda x: Preprocessor.expand_contractions(str(x)))
        ...
        for i in range(n):
            ...
            for tag in tagged_sent:
                wordnet_pos = Preprocessor.get_wordnet_pos(tag[1]) or wordnet.NOUN
        ...
        df.to_csv('sample0905.csv', encoding="utf-8")
        return df
